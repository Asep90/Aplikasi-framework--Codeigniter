...
<html>
	...
	<link href="<?php echo base_url();?>assets/https://fonts.googleapis.com/css?family=Work+Sans:300,400,500,700,800" rel="stylesheet">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-11 text-right menu-1">
						<ul>
							<li class="active"><a href="<?php echo base_url().'index.php/asep'?>">Home</a></li>
							<li><a href="<?php echo base_url().'index.php/asep/courses'?>">Courses</a></li>
							<li><a href="<?php echo base_url().'index.php/asep/pricing'?>">Pricing</a></li>
							<li class="has-dropdown">
								<a href="<?php echo base_url().'index.php/asep/blog'?>">Blog</a>
								<ul class="dropdown">
							...
							<li><a href="<?php echo base_url().'index.php/asep/contact'?>">Contact</a></li>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>NAMA  : ASEP ANDRIYANTO
								KELAS : E1 SEMESTER 6
								PRODI : T. INFORMATIKA</h1>
							<h2>UAS WEB <a href="<?php echo base_url();?>assets/http://freehtml5.co/" target="_blank">freehtml5.co</a></h2>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-push-5 animate-box">
						<img class="img-responsive" src="<?php echo base_url();?>assets/images/rico.png" alt="work">
					</div>
					<div class="col-md-4 col-md-pull-8 animate-box">
						<div class="mt">
							...
							<p><a class="btn btn-primary btn-lg popup-vimeo btn-video" href="<?php echo base_url();?>assets/https://vimeo.com/channels/staffpicks/93951774"><i class="icon-play"></i> Watch Video</a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-pull-1 animate-box">
						<img class="img-responsive" src="<?php echo base_url();?>assets/images/work_1.png" alt="work">
					</div>
		...
		<div class="container-fluid proj-bottom">
			<div class="row">
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/images/asip.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Web Master</h3>
						<span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/images/sip.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Virtual Assistant</h3>
						<span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/images/ha.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Read Bible</h3>
						<span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/images/ko.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Programming</h3>
						<span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/images/asik.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Technician</h3>
						<span>View Course</span>
					</a>
				</div>
				<div class="col-md-4 col-sm-6 fh5co-project animate-box" data-animate-effect="fadeIn">
					<a href="#"><img src="<?php echo base_url();?>assets/images/aku.jpg" alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
						<h3>Pothografy</h3>
						<span>View Course</span>
					</a>
				</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#"><img class="img-responsive" src="<?php echo base_url();?>assets/images/project-4.jpg" alt=""></a>
						<div class="blog-text">
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#"><img class="img-responsive" src="<?php echo base_url();?>assets/images/project-2.jpg" alt=""></a>
						<div class="blog-text">
				...
				<div class="col-lg-4 col-md-4">
					<div class="fh5co-blog animate-box">
						<a href="#"><img class="img-responsive" src="<?php echo base_url();?>assets/images/project-3.jpg" alt=""></a>
						<div class="blog-text">
							<h3><a href=""#>45 Minimal Workspace Rooms for Web Savvys</a></h3>
							<span class="posted_on">Nov. 15th</span>
							<span class="comment"><a href="">21<i class="icon-speech-bubble"></i></a></span>
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						...
						<small class="block">Designed by <a href="<?php echo base_url();?>assets/http://freehtml5.co/" target="_blank">FreeHTML5.co</a> Demo Images: <a href="http://unsplash.co/" target="_blank">Unsplash</a></small>
					</p>
					<p>
